	...
	'/notes/': [
		...
		},
		{
			...
			children: [
				...
				'Typora主题优化.md',
				'ja-netfilte激活jetbra全家桶包括插件统统激活.md',
				'3分钟了解MacBook m1芯片使用docker安装nginx.md',
				'3分钟完成Macbook m1芯片使用docker安装Elasticsearch和Kibana.md',
			],
		},
		{
			text: 'JUC高并发编程',
			icon: '/assets/icon/juc.png',
			collapsible: true,
			prefix: '/notes/juc/',
			children: [
				'一、线程基础.md',
	...
	'/devops/': [
		...
		},
		{
			...
			children: [
				...
				'8.Docker常规安装简介.md',
				'Docker开发中的一些问题.md',
				'Docker Mac M3 启动nginx 并且部署本地博客',
			],
		},
		{
			text: 'Docker高级篇',
			icon: '/assets/icon/docker_pro.png',
	...
	'/web/': [
		...
		},
		{
			...
			children: [
				{
					text: 'Less预处理器',
					icon: '/assets/icon/less.png',
					prefix: 'less/',
					children: ['01 【less学习笔记】.md'],
				},
				{
					text: 'Sass预处理器',
					icon: '/assets/icon/sass.png',
					prefix: 'sass/',
					children: [
						'01、Sass的安装使用.md',
						'02、Sass语法介绍-变量.md',
		...
		{
			text: '前端代码规范',
			icon: '/assets/icon/web_specification.png',
			collapsible: true,
			prefix: '/web/specification/',
			children: ['01 【JS 代码规范】.md', '02 【CSS 代码规范】.md', '03 【Git 提交规范】.md'],
		},
		{
			text: '前端构建工具',
			icon: 'view',
